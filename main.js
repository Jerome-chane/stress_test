    ...
    methods: {
        ...
        filt() {
            ...
            for (let criteria in this.books) {
                if (this.books[criteria].language.includes(this.selectedLanguage)) {
                    if (this.books[criteria].description.toLowerCase().includes(this.research.toLowerCase()) || this.books[criteria].title.toLowerCase().includes(this.research.toLowerCase())) {
